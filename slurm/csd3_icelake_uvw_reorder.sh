...
TILE_SIZE="10_000.0 10_000.0 20_000.0"
MAX_VIS_PER_CHUNK=10_000_000
...
# directory
cd ${OUTPUT_DIR}
ska-sdp-cip-reorder-uvw ${INPUT_MS} -t ${TILE_SIZE} \
    -d ${DASK_SCHEDULER_ADDRESS} -o ${OUTPUT_DIR} -m ${MAX_VIS_PER_CHUNK}
